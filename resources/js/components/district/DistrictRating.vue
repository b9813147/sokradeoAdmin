...
export default {
    ...
    methods: {
        initialize() {
            let _this = this;
            let url = `/api/district/rating/${this.$store.state.Auth.user.district_id}`;
        ...
        defaultColumns() {
            ...
            const header = [
                ...
                {text: this.$t('rating_order'), value: 'type'},
        ...
        deleteItem(item) {
            let _this = this;
            let url = `/api/district/rating/${item.id}`
        ...
        save() {
            let _this = this;
            let district_id = this.$store.state.Auth.user.district_id
            _this.$store.dispatch("updateLoading", true);
            let url = `/api/district/rating/${this.editedItem.id}`
            let params = {
        ...
        sort(e) {
            let _this = this;
            let url = `/api/district/rating/sort/${e.moved.element.id}`
            let params = {
